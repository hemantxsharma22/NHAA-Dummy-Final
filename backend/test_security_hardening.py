"""
Automated Security Hardening & RBAC Test Suite for NHAA & SAATHI-AI Platform.
Tests:
  ...
  4. Case Triage, AI Overrides, and Escalations
  5. Audit Trail Logging (CASE_ACCESS, COMPLAINT_FILED, TRIAGE_UPDATE, ESCALATION, OVERRIDE, AI_RECOMMENDATION)
  6. Secret & PII Sanitization in Audit Logs
  7. In-Memory API Rate Limiting (HTTP 429 Too Many Requests)
...
def test_firebase_token_handling():
    ...
    # Test rejection of non-RS256 tokens without mock flag
...
def test_audit_logging_and_sanitization(tokens, case_id):
    ...
    for log_item in logs:
        text = str(log_item.get("rationale") or "")
