...
class SlidingWindowRateLimiter:
    ...
    def __init__(self):
        ...
        # key: (client_ip, bucket_name) -> list of timestamp floats
        self._requests: Dict[Tuple[str, str], List[float]] = {}
        self._last_cleanup = time.time()

    def is_allowed(self, client_ip: str, bucket: str, limit: int, window_seconds: int = 60) -> Tuple[bool, int, int]:
        """
...
class RateLimitMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next):
        ...
        # Bypass rate limits for health, docs, and non-api routes
